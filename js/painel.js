  ...
  const dispCard=`
    <div class="pm-card pm-card-disp">
      ...
      <div class="pm-disp-content2">
        <button class="pm-disp-withdraw" type="button" aria-label="Solicitar saque do saldo disponível">
          ${ic('wallet')} <span>Solicitar Saque</span>
        </button>
      </div>
    </div>`;
...
const REP={
  'rel-crono':{
    ...
    fields:[F_DE,F_ATE,F_EVENTO,F_DIST,
  ...
  'rel-crono-r':{
    ...
    fields:[F_DE,F_ATE,F_EVENTO,F_DIST,F_CIDADE,F_TGPGTO],
  ...
  'rel-inscricoes':{
    ...
    fields:[F_DE,F_ATE,F_EVENTO,F_DIST,F_ORG,
      {t:'select',label:'Forma de Pagamento',ph:'Todas as formas',options:['PIX','Cartão de Crédito','Boleto']},
      {t:'select',label:'Status da Inscrição',options:['Todas','Aberta','Bloqueada','Cancelada','Confirmada','Cortesia','Pago','Estornadas','Sorteio Cortesia']},
      F_CIDADE,
  ...
  'rel-agrupadas':{
    ...
    fields:[F_DE,F_ATE,
      ...
      F_ORG,
      {t:'select',label:'Agrupar por',options:['Camiseta','Cidade','Equipe','Categoria','Distância','Forma de Pagamento']},
      F_TGPGTO],
  ...
  'rel-externas':{
    ...
    fields:[F_DE,F_ATE,F_EVENTO,F_DIST,
      {t:'select',label:'Status',ph:'Todos os status',options:['Todas','Cortesia','Pago','A Receber','Outro']}],
    includes:[['Inscrições externas','24'],['Status da inscrição','✓'],['Responsável pela inclusão','✓'],['Kit e Camiseta','✓'],['Data de importação','✓']],
